...
ckp_path = 'stdf-pytorch/exp/MFQEv2_R3_enlarge300x/ckp_290000.pt'  # trained at QP37, LDP, HM16.5
...
def main():
    ...
    raw_y = utils.import_yuv(
        seq_path=args.raw_path, h=h, w=w, tot_frm=nfs, start_frm=0, only_y=True
        )
    lq_y = utils.import_yuv(
        seq_path=args.decoded_path, h=h, w=w, tot_frm=nfs, start_frm=0, only_y=True
        )
